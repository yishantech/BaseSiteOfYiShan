...
function perth_scripts() {
	...
	if ( get_theme_mod('body_font_name') !='' ) {
	    wp_enqueue_style( 'perth-body-fonts', '//fonts.useso.com/css?family=' . esc_attr(get_theme_mod('body_font_name')) ); 
	} else {
	    wp_enqueue_style( 'perth-body-fonts', '//fonts.useso.com/css?family=Roboto:500,300,500italic,300italic');
	}

	if ( get_theme_mod('headings_font_name') !='' ) {
	    wp_enqueue_style( 'perth-headings-fonts', '//fonts.useso.com/css?family=' . esc_attr(get_theme_mod('headings_font_name')) ); 
	} else {
	    wp_enqueue_style( 'perth-headings-fonts', '//fonts.useso.com/css?family=Open+Sans:400italic,600italic,400,600,800'); 
	}
