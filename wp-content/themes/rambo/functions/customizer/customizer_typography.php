...
//Typography 
class rambo_Customize_typography_upgrade extends WP_Customize_Control {
		public function render_content() { ?>
        <h3><?php _e('Want to add Typography Setting Then','rambo'); ?><a href="<?php echo esc_url( 'http://www.webriti.com/rambo' ); ?>" target="_blank"><?php _e(' Upgrade To Pro','rambo'); ?> </a></h3>  
		<?php
		}
	}
...
$wp_customize->add_setting( 'rambo_theme_options[typography_upgrade]', array(
		'default'				=> false,
		'capability'			=> 'edit_theme_options',
		'sanitize_callback'	=> 'wp_filter_nohtml_kses',
	));
	$wp_customize->add_control(
		new rambo_Customize_typography_upgrade(
		$wp_customize,
		'rambo_theme_options[typography_upgrade]',
			array(
				'label'					=> __('Rambo Upgrade','rambo'),
				'section'				=> 'rambo_typography_section',
				'settings'				=> 'rambo_theme_options[typography_upgrade]',
			)
		)
	);	
...
$wp_customize->add_section( 'rambo_general_typography' , array(
		'title'      => __('General Typography', 'rambo'),
		'panel' => 'rambo_typography_setting',
		'priority'       => 1,
   	) );	
$wp_customize->add_setting(
...
$wp_customize->add_section( 'rambo_menus_typography' , array(
		'title'      => __('Menus Typography', 'rambo'),
		'panel' => 'rambo_typography_setting',
		'priority'       => 2,
   	) );	
$wp_customize->add_setting(
...
$wp_customize->add_section( 'rambo_post_page_title_typography' , array(
		'title'      => __('Post / Page Typography', 'rambo'),
		'panel' => 'rambo_typography_setting',
		'priority'       => 3,
   	) );	
$wp_customize->add_setting(
...
// page title typography section
$wp_customize->add_section( 'rambo_page_title_typography' , array(
		'title'      => __('Post / Page Typography', 'rambo'),
		'panel' => 'rambo_typography_setting',
		'priority'       => 3,
   	) );	
$wp_customize->add_setting(
    'rambo_pro_theme_options[page_title_fontsize]',
    array(
        'default'           =>  30,
		'capability'        =>  'edit_theme_options',
		'sanitize_callback' =>  'sanitize_text_field',
...
$wp_customize->add_control('rambo_pro_theme_options[page_title_fontsize]', array(
		'label' => __('Font Size','rambo'),
        'section' => 'rambo_page_title_typography',
		'setting' => 'rambo_pro_theme_options[page_title_fontsize]',
		'type'    =>  'select',
		'choices'=>$font_size,
		'description'=>'(Pixels)'
    ));
...
$wp_customize->add_section( 'rambo_service_typography' , array(
		'title'      => __('Service Title Typography', 'rambo'),
		'panel' => 'rambo_typography_setting',
		'priority'       => 4,
   	) );	
$wp_customize->add_setting(
...
$wp_customize->add_section( 'rambo_portfolio_typography' , array(
		'title'      => __('Portfolio Title Typography', 'rambo'),
		'panel' => 'rambo_typography_setting',
		'priority'       => 5,
   	) );	
$wp_customize->add_setting(
...
$wp_customize->add_section( 'rambo_site_intro_typography' , array(
		'title'      => __('Call Out Area Title', 'rambo'),
		'panel' => 'rambo_typography_setting',
		'priority'       => 7,
   	) );	
$wp_customize->add_setting(
...
$wp_customize->add_section( 'rambo_callout_desc_typography' , array(
		'title'      => __('Call Out Area Description', 'rambo'),
		'panel' => 'rambo_typography_setting',
		'priority'       => 8,
   	) );	
$wp_customize->add_setting(
    'rambo_pro_theme_options[calloutarea_description_fontsize]',
    array(
        'default'           =>  15,
		'capability'        =>  'edit_theme_options',
		'sanitize_callback' =>  'sanitize_text_field',
...
$wp_customize->add_section( 'rambo_callout_button_typography' , array(
		'title'      => __('Call Out Area Button', 'rambo'),
		'panel' => 'rambo_typography_setting',
		'priority'       => 9,
   	) );	
$wp_customize->add_setting(
