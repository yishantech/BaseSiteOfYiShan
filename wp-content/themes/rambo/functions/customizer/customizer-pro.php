...
class WP_Pro_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
     <div class="pro-box">
       <a href="<?php echo esc_url( __('http://webriti.com/rambo/', 'rambo'));?>" target="_blank" class="upgrade" id="review_pro"><?php _e( 'UPGRADE  TO PRO','rambo' ); ?></a>
...
$wp_customize->add_section( 'rambo_pro_section' , array(
		'title'      => __('UPGRADE  TO PRO VERSION', 'rambo'),
		'priority'   => 1100,
   	) );
...
class WP_Review_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
	  <div class="pro-box">
     <a href="<?php echo esc_url( __('https://wordpress.org/support/view/theme-reviews/rambo#postform/', 'rambo'));?>" target="_blank" class="review" id="review_pro"><?php _e( 'ADD YOUR REVIEW','rambo' ); ?></a>
	 </div>
    <?php
    }
}
...
class WP_document_Customize_Control extends WP_Customize_Control {
    ...
    */
    ...
    ?>
      <div class="pro-box">
	 <a href="<?php echo esc_url( __('http://webriti.com/help/', 'rambo'));?>" target="_blank" class="document" id="review_pro"><?php _e( 'DOCUMENTATION','rambo' ); ?></a>
